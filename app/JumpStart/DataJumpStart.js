...
const cardData = [
    ...
    },
    {
        ...
        summary: [
        <span key="bold-text">
            I recently graduated with a PhD in behavioural ecology which imbued me with
        ...
        <span key="bold-text">
            Not to mention a pantheon of useful <strong>technical skills</strong> which I am now using in my part-time, pro-bono role as a Founding Developer at <strong>tech startup, Blob</strong>.</span>,
        <span key="bold-text">I am looking for a startup role where I can leverage all the skills I have gained over a range of different projects.</span>
        ],
        bullets: [],
        visible: false
    },
            ...
            },
            {
                ...
                moreInfo: (
                    <ul className={styles.customBullets}>
                        ...
                        <li>When my relationship with my supervisor began to falter, I took proactive steps to address it. We had a hard, honest conversation and realigned our expectations of one another. After that conversation, our relationship was much more productive than it had been before. </li>
            ...
            },
            {
                ...
                moreInfo: (
                    <ul className={styles.customBullets}>
                        ...
                        <li>I thrive in dynamic environments at Blob, a startup, where I tackle a range of projects from crafting a minimum viable product to devising comprehensive data strategies. My ability to seamlessly shift between diverse tasks ensures that I deliver effective results across various aspects of our initiatives.</li>
                    </ul>
                )
            },
            {
    ...
    {
        title: <span style={{ fontSize: '30px', display: 'block', textAlign: 'center' }}>Why JumpStart?</span>,
        summary: [
            <span key="bold-text" style={{ display: 'block', textAlign: 'center' }}>
                Jumpstart's generalist stream offers something special: access to <strong>top-tier VC-funded startups</strong>.</span>,
            <span key="bold-text" style={{ display: 'block', textAlign: 'center' }}>
                More than just that, JumpStart provides professional support and access to a community of like-minded people.</span>,
            <span key="bold-text" style={{ display: 'block', textAlign: 'center' }}>This opportunity is ideal for me, as it eliminates the need for a time-consuming job search and will directly link me with the best companies to kickstart my career.</span>,        ],
        bullets: [],
        visible: false
    },
    {
        ...
        summary: [
            <span key="bold-text" style={{ display: 'block', textAlign: 'center' }}>I hope this page has demonstrated that I am <strong>eager to work</strong> and keen to take on new challenges.</span>,
